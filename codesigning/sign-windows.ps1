...
#
# [Cert comun GDC, 2026-09-06] Secretele WIN_SELFSIGN_PFX_BASE64 /
# WIN_SELFSIGN_PFX_PASSWORD sunt IDENTICE in toate repo-urile GDC
# (decizie explicita Cristi) - acelasi certificat self-signed semneaza
# toate aplicatiile GDC, ca un colaborator care a importat .cer-ul o
# singura data sa aiba incredere in orice build GDC viitor, nu doar in
# acesta. Acest script e portabil 1:1 intre repo-uri - nu contine nimic
# specific GDC Vault.
...
try {
    ...
    # valideaza LANTUL COMPLET de incredere (pana la un certificat radacina
    # de incredere pe MASINA care verifica) - pe runner-ul CI (o masina
