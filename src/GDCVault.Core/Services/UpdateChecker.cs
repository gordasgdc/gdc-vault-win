...
public sealed class UpdateChecker : INotifyPropertyChanged
{
    ...
    private static readonly Uri LatestReleaseApiUrl =
        new("https://api.github.com/repos/gordasgdc/gdc-vault-win/releases/latest");
    ...
    {
        _http.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("GDCVault", CurrentVersion));
    ...
    private static string DismissedVersionFilePath =>
        Path.Combine(
            ...
            "GDCVault", "dismissed-update-version.txt");
