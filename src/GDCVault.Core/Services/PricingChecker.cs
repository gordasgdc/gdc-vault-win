...
/// din `ActivationWindow.xaml.cs`. Fail-open: fără conexiune sau
/// `productID` lipsă, se folosește `FallbackBasePrice` (5 €, valoarea
/// hardcodată anterior).
public sealed class PricingChecker : INotifyPropertyChanged
{
    ...
    private const string ProductID = "gdc-vault";
    public const double FallbackBasePrice = 5;
    ...
    public async Task RefreshAsync()
    {
        try
        {
            ...
            client.DefaultRequestHeaders.UserAgent.ParseAdd("GDCVault");
